...
class SnippetAllWordsView(generics.ListAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        logger.info(f"Fetching all words for video {youtube_id}, snippet {index}, user {request.user.id}")
        ...
        try:
            ...
            logger.info(f"Returning {len(transformed_words)} words")
            ...
            logger.error(f"Unexpected error in SnippetAllWordsView: {str(e)}")
            raise
